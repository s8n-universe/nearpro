    ...
    return `
        ...
        <section class="app-cta-banner">
            <div class="container cta-banner-content">
                ...
                <p>Download the MappCall application on mobile to consult with professionals, chat live, and initiate secure calls on the go.</p>
                <div class="download-buttons">
                    <a href="https://play.google.com/store/apps/details?id=com.mappcall" target="_blank" class="store-btn">
                    ...
                    <a href="https://apps.apple.com/in/app/mappcall" target="_blank" class="store-btn">
