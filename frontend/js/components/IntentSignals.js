...
export function renderIntentSignals() {
    ...
    const feedCardsHTML = activeList.length === 0 ? `
        <div style="grid-column: 1 / -1; padding: 60px 24px; text-align: center; border: 1px dashed rgba(255,255,255,0.08); border-radius: var(--radius-lg); background: #111115;">
            ...
            <h3 style="color: white; font-family: var(--font-heading); font-size: 18px; margin-bottom: 8px;">No Active Intent Signals</h3>
    ...
    ` : activeList.map(s => {
        ...
        return `
            <div style="background: #111115; border: 1px solid #222227; border-radius: 12px; padding: 20px; display: flex; flex-direction: column; gap: 14px; position: relative;">
                ...
                <div style="display: flex; justify-content: space-between; align-items: start; gap: 16px;">
                    <div>
                        <div style="display: flex; align-items: center; gap: 8px; margin-bottom: 6px;">
                            ...
                            <span style="font-size: 11.5px; color: #a1a1aa;">Detected ${new Date(s.detected_at).toLocaleTimeString()}</span>
                        </div>
                        <h4 style="margin: 0; color: white; font-family: var(--font-heading); font-size: 15px; font-weight: 800;">
                            ${s.title}
                        </h4>
                        <p style="margin: 4px 0 0 0; color: #a1a1aa; font-size: 12.5px; line-height: 1.4;">
                    ...
                    <div style="text-align: right;">
                        ...
                        <div style="width: 80px; height: 4px; background: #222227; border-radius: 10px; overflow: hidden; margin-top: 4px;">
                ...
                <!-- Info detail -->
                <div style="background: #09090b; border: 1px solid #222227; border-radius: 6px; padding: 12px; font-size: 12.5px; color: #a1a1aa; line-height: 1.4;">
                ...
                <!-- Actions footer -->
                <div style="display: flex; gap: 8px; justify-content: flex-end; border-top: 1px solid #222227; padding-top: 12px;">
                    <button class="brand-btn signal-action-btn view-lead" data-id="${lead.id}" style="padding: 6px 12px; font-size: 11.5px; font-weight: 700; background: rgba(255,255,255,0.06); border: 1px solid rgba(255,255,255,0.08); color: white;">
                        View Lead Details
                    </button>
    ...
    const watchlistsHTML = watch.length === 0 ? `
        <div style="color: #a1a1aa; font-size: 12.5px; padding: 20px 0; text-align: center;">
            No watchlists created yet.
        </div>
    ` : watch.map(w => `
        <div style="background: #09090b; border: 1px solid #222227; border-radius: 8px; padding: 14px; margin-bottom: 10px;">
            <div style="font-size: 13.5px; font-weight: 700; color: white;">🎯 ${w.name}</div>
    ...
    return `
        <div style="max-width: 1200px; display: flex; flex-direction: column; gap: 24px; color: white; padding-bottom: 40px;">
            ...
            <div style="background: linear-gradient(135deg, rgba(239,68,68,0.04) 0%, rgba(37,99,235,0.02) 100%); border: 1px solid #222227; border-radius: 12px; padding: 24px; display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 20px;">
                <div style="display: flex; flex-direction: column; gap: 4px;">
                    <h3 style="margin: 0; font-size: 20px; font-weight: 800; font-family: var(--font-heading); display: flex; align-items: center; gap: 8px;">
                        ...
                        <span style="font-size: 10px; background: rgba(239, 68, 68, 0.15); border: 1px solid rgba(239, 68, 68, 0.3); color: #ef4444; font-weight: 800; padding: 2px 8px; border-radius: 50px; text-transform: uppercase; font-family: var(--font-mono);">Scout Gated</span>
                    </h3>
                    <p style="margin: 0; font-size: 13.5px; color: #a1a1aa;">Track real-time hiring changes, news mentions, reviews spikes, and trigger optimized outreach pitches instantly.</p>
                </div>
                
                <div style="display: flex; gap: 10px;">
                    <button class="brand-btn" id="signalsRunScanBtn" style="background: rgba(255,255,255,0.06); border: 1px solid rgba(255,255,255,0.08); color: white; font-weight: 800; padding: 10px 18px;">
            ...
            <div style="display: grid; grid-template-columns: 1.15fr 0.85fr; gap: 24px; align-items: start; flex-wrap: wrap;">
                ...
                <!-- Left: Signals Feed -->
                <div>
                    <h3 style="margin: 0 0 16px 0; font-size: 17px; font-family: var(--font-heading); font-weight: 800; display:flex; align-items:center; gap:8px;">
        ...
        <div id="watchlistModalOverlay" style="display: none; position: fixed; inset: 0; background: rgba(0,0,0,0.6); backdrop-filter: blur(4px); z-index: 10000; align-items: center; justify-content: center; padding: 24px;">
            <div style="background: #111115; border: 1px solid #222227; border-radius: 12px; max-width: 440px; width: 100%; overflow: hidden; box-shadow: 0 20px 50px rgba(0,0,0,0.5);">
                <div style="padding: 20px; border-bottom: 1px solid #222227; display: flex; justify-content: space-between; align-items: center;">
                    <h3 style="margin:0; font-size: 16px; font-weight:800; font-family:var(--font-heading);">Create Signal Watchlist</h3>
                    <button class="brand-btn" id="closeWatchlistModal" style="background:none; border:none; padding:4px; font-size:18px; line-height:1; color:#a1a1aa; cursor:pointer;">×</button>
                </div>
                
                <div style="padding: 20px; display: flex; flex-direction: column; gap: 14px;">
                    <div>
                        <label style="display: block; font-size: 12.5px; font-weight: 700; color: #a1a1aa; margin-bottom: 6px;">Watchlist Name</label>
                        <input type="text" id="watchNameInput" placeholder="e.g. Bandra Clinic Leads" style="width: 100%; padding: 10px 14px; background: #09090b; border: 1.5px solid #222227; border-radius: 6px; color: white; font-size: 13.5px; outline: none;" />
                    </div>

                    <div>
                        <label style="display: block; font-size: 12.5px; font-weight: 700; color: #a1a1aa; margin-bottom: 6px;">Description</label>
                        <textarea id="watchDescInput" placeholder="Optional notes..." style="width: 100%; height: 80px; padding: 10px 14px; background: #09090b; border: 1.5px solid #222227; border-radius: 6px; color: white; font-size: 13px; outline: none; resize: none;"></textarea>
                    </div>

                    <div>
                        <label style="display: block; font-size: 12.5px; font-weight: 700; color: #a1a1aa; margin-bottom: 6px;">Scan Check Frequency</label>
                        <select id="watchFreqSelect" style="width: 100%; padding: 10px 14px; background: #09090b; border: 1px solid #222227; border-radius: 6px; color: white; font-size: 13.5px; outline: none;">
                ...
                <div style="padding: 20px; border-top: 1px solid #222227; display: flex; justify-content: flex-end; gap: 10px;">
                    <button class="brand-btn" id="cancelWatchlistBtn" style="padding: 8px 16px; font-size:12.5px; background:rgba(255,255,255,0.06); color:white; border: 1px solid rgba(255,255,255,0.08);">Cancel</button>
