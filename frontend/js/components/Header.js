                    ...
                    ` : `
                        <div class="navbar-ticker" style="overflow: hidden; white-space: nowrap; max-width: 350px; font-size: 11.5px; font-weight: 700; color: var(--accent-gold); display: flex; align-items: center; gap: 8px; border: 1px solid rgba(255,160,0,0.2); padding: 4px 12px; border-radius: 20px; background: rgba(255,160,0,0.03);">
                            ...
                            <div class="ticker-viewport" style="overflow: hidden; width: 100%; position: relative; height: 16px;">
                                <div class="ticker-track" style="display: inline-block; white-space: nowrap; position: absolute; animation: marquee 35s linear infinite; width: max-content;">
                                    🚀 NearPro maps 5,390+ verified B2B leads across Mumbai! &bull; 📱 Scan any local website in 10 seconds to discover performance leaks! &bull; 💸 Pitch ₹30,000 layouts to high-intent 'Gap Leads'! &bull; 📄 Create custom B2B PDF audit proposals in under 30 seconds! &bull; 📞 Click objection rebuttals on-the-fly with AI Call Teleprompter! &bull; 🚀 Push closed deals directly to Google Sheets & HubSpot! &bull; 🚀 NearPro maps 5,390+ verified B2B leads across Mumbai! &bull; 📱 Scan any local website in 10 seconds to discover performance leaks! &bull; 💸 Pitch ₹30,000 layouts to high-intent 'Gap Leads'! &bull; 📄 Create custom B2B PDF audit proposals in under 30 seconds! &bull; 📞 Click objection rebuttals on-the-fly with AI Call Teleprompter! &bull; 🚀 Push closed deals directly to Google Sheets & HubSpot!
                                </div>
                            </div>
                        </div>
                    `}
