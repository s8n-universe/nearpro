...
export function renderAuthModal() {
    ...
    return `
            ...
            <div class="auth-split-container">
                ...
                <div class="auth-left-pane">
                    ...
                    <div style="width: 100%; max-width: 340px; margin: 0 auto;">
                        <h2 style="font-size: 24px; font-weight: 700; margin-bottom: 24px; text-align: left; font-family: var(--font-heading); color: #0f172a; display: flex; align-items: center; gap: 8px;">
                        ...
                        <!-- Zoho Authentication -->
                        <button id="zohoAuthBtn" class="secondary-btn" style="width: 100%; display: flex; align-items: center; justify-content: center; gap: 8px; margin-bottom: 20px; padding: 10px 14px; border-radius: var(--radius-sm); border: 1px solid #cbd5e1; background: white; color: #0f172a; font-size: 13px; font-weight: 600; cursor: pointer; transition: opacity 0.2s;">
                        ...
                        <div style="display: flex; align-items: center; margin-bottom: 20px;">
                            ...
                            <span style="padding: 0 10px; font-size: 11px; color: #64748b; font-family: var(--font-mono); font-weight: 600;">OR</span>
                            <hr style="flex: 1; border: none; border-top: 1px solid #e2e8f0;">
                        </div>
                        
                        <!-- Tab headers -->
                        <div style="display: flex; gap: 12px; border-bottom: 1px solid #e2e8f0; margin-bottom: 20px;">
                            <button id="signInTabBtn" class="tab-header-btn active" style="flex: 1; padding-bottom: 6px; font-size: 13px; background: none; border: none; border-bottom: 2px solid var(--accent-gold); color: #0f172a; cursor: pointer; font-weight: 700;">
                                Sign In
                            </button>
                            <button id="signUpTabBtn" class="tab-header-btn" style="flex: 1; padding-bottom: 6px; font-size: 13px; background: none; border: none; border-bottom: 2px solid transparent; color: #64748b; cursor: pointer; font-weight: 700;">
                                Register
                            </button>
                        </div>
                        ...
                        <form id="authForm">
                            <div style="margin-bottom: 12px;">
                                <label style="display: block; font-size: 11px; color: #475569; margin-bottom: 4px; font-family: var(--font-mono); font-weight: 600;">Email Address</label>
                                <input type="email" id="authEmailInput" class="auth-input" required placeholder="name@domain.com" style="width:100%; padding:10px 12px; background:#f8fafc; border:1px solid #cbd5e1; border-radius:6px; color:#0f172a; font-size:13px; outline:none; transition: border-color 0.2s;">
                            </div>
                            
                            <div style="margin-bottom: 20px;">
                                <label style="display: block; font-size: 11px; color: #475569; margin-bottom: 4px; font-family: var(--font-mono); font-weight: 600;">Password</label>
                                <input type="password" id="authPasswordInput" class="auth-input" required placeholder="••••••••" style="width:100%; padding:10px 12px; background:#f8fafc; border:1px solid #cbd5e1; border-radius:6px; color:#0f172a; font-size:13px; outline:none; transition: border-color 0.2s;">
                            </div>
                            ...
                            <button type="submit" id="authSubmitBtn" class="brand-btn" style="width: 100%; padding: 10px; font-size: 13.5px; font-weight: 700; cursor: pointer; background: linear-gradient(135deg, var(--accent-gold), #ea580c); color: white; border: none; border-radius: 6px;">
                                Sign In
                            </button>
                            
                            <div style="margin-top: 16px; text-align: center; font-size: 12.5px; color: #475569;">
                ...
                <div class="auth-right-pane">
                    ...
                    <div style="display: flex; justify-content: space-between; align-items: center; z-index: 2;">
                        ...
                        <span style="font-size: 11.5px; color: var(--text-muted); font-family: var(--font-mono);">Differentiators</span>
                    </div>

                    <div style="z-index: 2; margin: auto 0; display: flex; flex-direction: column; gap: 32px;">
                        <div style="max-width: 520px;">
                            <h1 style="font-size: 34px; font-weight: 800; font-family: var(--font-heading); color: white; line-height: 1.25; margin: 0 0 12px 0; letter-spacing: -0.5px;">
                                Transform local search directory data into sales pipelines
                            </h1>
                            <p style="color: var(--text-secondary); font-size: 14.5px; line-height: 1.6; margin: 0;">
                                NearPro does what standard CRMs cannot. We generate high value website briefs, provide live call teleprompters with rebuttal cards, and calculate lost prospect revenue instantly.
                            </p>
                        </div>

                        <!-- CSS Differentiators Mockup Stack -->
                        <div class="auth-mockup-wrapper" style="position: relative; height: 280px; width: 100%; max-width: 580px;">
                            
                            <!-- Lost Monthly Revenue Estimator Card -->
                            <div class="auth-mockup-card" style="position: absolute; left: 0; top: 0; width: 280px; background: rgba(30, 41, 59, 0.7); backdrop-filter: blur(12px); -webkit-backdrop-filter: blur(12px); border: 1px solid rgba(255,255,255,0.08); border-radius: 12px; padding: 16px; box-shadow: 0 20px 40px rgba(0,0,0,0.4); z-index: 3; transition: all 0.3s ease; cursor: default;">
                                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 12px;">
                                    <span style="font-size: 10px; font-family: var(--font-mono); color: var(--accent-gold); font-weight: 700; text-transform: uppercase;">Lost Revenue Estimator</span>
                                    <span style="background: rgba(239, 68, 68, 0.15); color: #ef4444; padding: 2px 6px; border-radius: 4px; font-size: 9.5px; font-weight: bold; font-family: var(--font-mono);">HIGH RISK</span>
                                </div>
                                <div style="display: flex; align-items: center; gap: 14px;">
                                    <div style="position: relative; width: 48px; height: 48px; display: flex; align-items: center; justify-content: center; background: radial-gradient(closest-side, #1e293b 79%, transparent 80% 100%), conic-gradient(#ef4444 85%, rgba(255,255,255,0.05) 0); border-radius: 50%;">
                                        <span style="font-size: 13px; font-weight: bold; color: white; font-family: var(--font-mono);">85%</span>
                                    </div>
                                    <div>
                                        <div style="font-size: 13px; font-weight: bold; color: white; margin-bottom: 2px;">PageSpeed Load Time Gap</div>
                                        <div style="font-size: 11px; color: var(--text-secondary);">Estimated loss: <span style="color: #ef4444; font-weight: bold;">₹45,000 / mo</span></div>
                                    </div>
                                </div>
                            </div>

                            <!-- AI Telesales Teleprompter Card -->
                            <div class="auth-mockup-card" style="position: absolute; right: 10px; top: 30px; width: 290px; background: rgba(30, 41, 59, 0.7); backdrop-filter: blur(12px); -webkit-backdrop-filter: blur(12px); border: 1px solid rgba(255,255,255,0.08); border-radius: 12px; padding: 16px; box-shadow: 0 25px 50px rgba(0,0,0,0.5); z-index: 2; transition: all 0.3s ease; cursor: default;">
                                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px;">
                                    <div style="display: flex; align-items: center; gap: 6px;">
                                        <span style="width: 8px; height: 8px; border-radius: 50%; background: #22c55e;"></span>
                                        <span style="font-size: 12px; font-weight: bold; color: white; font-family: var(--font-mono);">Telesales Script Helper</span>
                                    </div>
                                    <span style="font-size: 10px; color: var(--text-muted); font-family: var(--font-mono);">Live Call</span>
                                </div>
                                <div style="font-size: 11.5px; color: var(--text-secondary); line-height: 1.5;">
                                    <div style="background: rgba(255,255,255,0.04); padding: 8px 10px; border-radius: 6px; border-left: 2px solid var(--accent-gold); margin-bottom: 8px;">
                                        "We mapped your Bandra location and noticed a market gap that is costing you client bookings..."
                                    </div>
                                    <div style="display: flex; justify-content: space-between; font-size: 10.5px;">
                                        <span style="color: var(--accent-pink); font-weight: bold;">Click for budget rebuttal</span>
                                        <span style="color: var(--text-muted);">Toggled ➔</span>
                                    </div>
                                </div>
                            </div>

                            <!-- AI Website Builder Prompt Card -->
                            <div class="auth-mockup-card" style="position: absolute; left: 60px; bottom: -10px; width: 270px; background: rgba(30, 41, 59, 0.7); backdrop-filter: blur(12px); -webkit-backdrop-filter: blur(12px); border: 1px solid rgba(255,255,255,0.08); border-radius: 12px; padding: 14px 16px; box-shadow: 0 15px 35px rgba(0,0,0,0.45); z-index: 4; transition: all 0.3s ease; cursor: default; display: flex; align-items: center; gap: 10px;">
                                <div style="background: rgba(59, 130, 246, 0.1); width: 32px; height: 32px; border-radius: 6px; display: flex; align-items: center; justify-content: center; flex-shrink: 0; border: 1px solid rgba(59, 130, 246, 0.2);">
                                    <span style="font-size: 15px; animation: bounce 2s infinite;">🤖</span>
                                </div>
                                <div>
                                    <div style="font-size: 12.5px; font-weight: bold; color: white;">AI Builder Prompts</div>
                                    <div style="font-size: 10.5px; color: var(--text-secondary);">1 click briefs for Bolt.new &amp; Lovable</div>
                                </div>
                            </div>
        ...
        <style>
            ...
            .auth-right-pane {
                flex: 1;
                background: radial-gradient(circle at 80% 20%, rgba(245, 158, 11, 0.08), transparent 50%), radial-gradient(circle at 20% 80%, rgba(236, 72, 153, 0.05), transparent 50%), #0f172a;
                display: flex;
                flex-direction: column;
