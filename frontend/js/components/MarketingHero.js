    ...
    return `
        <section class="marketing-hero">
            <div class="container hero-content">
                ...
                <div id="heroScratchCouponBanner" style="margin: 0 auto 24px; display: inline-flex; align-items: center; gap: 10px; padding: 8px 18px; background: rgba(255, 160, 0, 0.12); border: 1.5px solid rgba(255, 160, 0, 0.4); border-radius: 100px; backdrop-filter: blur(8px); cursor: pointer; transition: all 0.2s ease; flex-wrap: wrap; justify-content: center;" onclick="window.State.setScratchModal(true)" onmouseover="this.style.background='rgba(255, 160, 0, 0.2)'; this.style.borderColor='rgba(255, 160, 0, 0.6)'" onmouseout="this.style.background='rgba(255, 160, 0, 0.12)'; this.style.borderColor='rgba(255, 160, 0, 0.4)'">
                    <span style="font-size: 13.5px; color: var(--accent-gold); font-weight: 800;">🔥 Launch Offer: First 100 Users Get Scout Plan FREE!</span>
                    <span style="color: rgba(255,255,255,0.4);">•</span>
                    <span style="font-size: 13px; color: #22c55e; font-weight: 700; font-family: var(--font-mono);" id="heroBannerRemainingText">58 / 100 Left</span>
