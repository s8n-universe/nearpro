...
export const FEATURE_GATES = {
    ...
    lead_notes: 'free',
    compare_modal: 'free',
    prompt_generator: 'free',
    website_audit: 'free',
    conversion_score: 'hunter',
    outreach_studio: 'free',
    unlimited_export: 'agency',
    follow_up_reminders: 'free',
    bulk_outreach: 'hunter',
    integration_hub: 'scout',
    team_workspace: 'free',
    data_requests: 'free',
    density_heatmap: 'free',
    gap_analysis: 'free',
    whitelabel_reports: 'hunter'
};
