    ...
    <tr>
      <td style="padding:18px 36px; background-color:#f8f8fa; border-top:1px solid #e8e8f0; text-align:center;">
        <p style="font-size:11.5px; color:#8c8599; margin:0 0 6px 0; font-family:'Inter', sans-serif; line-height:1.5;">
          ⚡ <strong>Automated System Notification:</strong> This is an automated system email generated by NearPro AI OS.
        </p>
        <p style="font-size:11.5px; color:#8c8599; margin:0; font-family:'Inter', sans-serif; line-height:1.5;">
          Need assistance or have a question? Reply directly to this email or contact support at <a href="mailto:${SUPPORT_EMAIL}" style="color:#ec4899; text-decoration:underline; font-weight:600;">${SUPPORT_EMAIL}</a>.
        </p>
      </td>
    </tr>
    `;
